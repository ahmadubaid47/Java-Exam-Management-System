 ...
 * @author ahmad
 */
public class Quiz_FormCS extends javax.swing.JFrame {
    VarDB dbt = new VarDB();
      DAO dao = new DAO();
    String w;
 ...
 cls=n;}
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Computer Studies");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(CR, javax.swing.GroupLayout.PREFERRED_SIZE, 219, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
...
dbt.r94=opt94.getText();if(dbt.r94.equals(dbt.j)){dbt.Counter=dbt.Counter+x10;mark10.setText(""+dbt.mark10); }
       ...
       int res = dao.Insert_Catagory2_Result(dbt);
            if (res>0)
            {
...
count.setText(""+dbt.Counter);
 ...
 public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            ...
            new Quiz_FormCS().setVisible(true);
        });
    }
